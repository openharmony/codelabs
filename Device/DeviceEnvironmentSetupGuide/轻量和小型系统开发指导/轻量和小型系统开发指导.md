...
这篇文章主要介绍的是在Ubuntu系统环境下对小型系统的源码进行编译及烧写。若搭建Windows开发环境请参考[Windows平台源码编译](https://device.harmonyos.com/cn/docs/documentation/guide/ide-hi3861v100-compile-0000001192526021#section730341492617)，下文将以Hi3861V100开发板为例进行介绍，开发板的具体外观和规格可参见附录，开发者可根据需要自行购买。
...
参考[搭建Ubuntu开发环境](zh-cn_topic_0000001187551294.md)

**下载并安装DevEco Device Tool（Windows）**

参考[搭建Windows开发环境](zh-cn_topic_0000001190944062.md)
