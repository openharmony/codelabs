...
这部分定义了整个页面中各个组件的样式，有关CSS更多的知识可以参考[CSS语法参考](https://gitee.com/openharmony/docs/blob/master/zh-cn/application-dev/reference/arkui-js/js-framework-syntax-css.md)，在index.css中先添加如下代码：
