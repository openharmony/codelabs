...
3. 搭建开发环境。
   ...
   2. 开发环境配置完成后，请参考[使用工程向导](https://gitee.com/openharmony/docs/blob/master/zh-cn/application-dev/quick-start/use-wizard-to-create-project.md)创建工程，选择JS或者eTS语言开发、“Application”为例，模板选择“\[Standard\]Empty Ability”，如下图所示：

      ![](figures/zh-cn_image_0000001215258348.png)
   ...
   ![](figures/zh-cn_image_0000001260018879.png)
