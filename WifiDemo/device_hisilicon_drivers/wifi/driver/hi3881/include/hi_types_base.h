...
#define hi_u16_bit_val(b12, b11, b10, b9, b8, b7, b6, b5, b4, b3, b2, b1, b0)                                        \
    (hi_u16)(((b12) << 12) | ((b11) << 11) | ((b10) << 10) | ((b9) << 9) | ((b8) << 8) | ((b7) << 7) | ((b6) << 6) | \
...
#define hi_reg_setbits(addr, pos, bits, val)                                                                 \
    (hi_reg_read_val32(addr) = (hi_reg_read_val32(addr) & (~((((unsigned int)1 << (bits)) - 1) << (pos)))) | \
...
#define hi_reg_setbits16(addr, pos, bits, val)                                                                 \
    (hi_reg_read_val16(addr) = (hi_reg_read_val16(addr) & (~((((unsigned short)1 << (bits)) - 1) << (pos)))) | \
