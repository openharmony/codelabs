...
export default class CommonConstants {
  ...
  static PRODUCT_LIST = [
    {
      ...
      userIcon: '/common/images/my/ic_person.png',
  ...
  static PRODUCT_DETAILS_ICON = {
    ...
    moreIcon: '/common/images/pendingPayment/ic_more.png',
    homeIcon: '/common/images/other/ic_home_disable.png',
    shoppingCartICon: '/common/images/other/ic_shopping_cart_disable.png'
  };
  ...
  static COMMON_ICON = {
    ...
    market: '/common/images/my/ic_person.png',
    product: '/common/images/shoppingCart/ic_product.png',
