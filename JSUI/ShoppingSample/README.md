...
本篇Codelab只对核心代码进行讲解，对于完整代码，我们会在gitcode中提供。由于本篇Codelab页面较多，因此component和pages目录下只展示“购物主页面”的hml、js、css。
...
本篇Codelab选取购物应用的主页面、购物车页面、以及导航栏进行详细的讲解，对于完整代码，可在gitcode源码中进行查看。
